...
class StartWindow(QtWidgets.QWidget):
    def __init__(self):
        ...
        VERSION = 1.0
        self.lab.setText(f"SynthereArt {VERSION} is Loading...")
        self.lab.setStyleSheet("""font-size:20px;color:#fff;text-align:center""")
    ...
    def run(self):
        # show main
        print("to run main")
        app.setApplicationName("SynthereArt")
        app.setStyle("Fusion")
